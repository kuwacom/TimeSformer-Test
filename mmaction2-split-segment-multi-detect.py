...
def split_segment_detect(video_path, model, label_path, test_pipeline=None, processing_frame_height=None, segment_duration=10, output_video_path='./output_video.mp4', temp_path='./temp', thread=2):
    """
...
split_segment_detect(
                        video_path, model, label_path, segment_duration=2,
                        processing_frame_height=1000, output_video_path=output_video_path,
                        thread=8
                    )
